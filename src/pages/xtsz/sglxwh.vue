<template>
  <div class="row q-pa-md">
   ...
   <div class="text-right q-gutter-sm q-pt-sm">
      <q-btn outline text-color="blue-8" label="新建施工类型" class="apply-btn" @click="layout = true"/>
    </div>
    <q-separator />
    <!--tab 切换 start -->
    ...
    <q-dialog v-model="layout" >
      <q-layout view="Lhh lpR fff" container class="bg-white" style="width:40%; max-width:40%;height:40%;">
        <q-header class="bg-primary">
          <q-toolbar>
            <q-toolbar-title>新建施工类型</q-toolbar-title>
 ...
 <div class="col-sm-5 col-xs-12">
            <div class="row items-center" style="margin-bottom:10px">
              <div class="col col-md-3 text-right">
                <div class="q-mr-sm" style="font-size:14px; color:#757575">施工类型名称：</div>
              </div>
              <div class="col col-md-8">
                <div class="text-body1"><q-input
                  v-model="lsit"
                  outlined
                  placeholder="请输入施工类型名称"
                  style="margin-bottom:-20px;"
                  dense
                  :rules="[ val => val && val.length > 0 || '请输入施工类型名称']"
                /></div>
              </div>              
            </div>         
  ...
  <div class="q-pa-md q-gutter-sm" style="width:100%">
    <q-dialog v-model="layout1" >
      <q-layout view="Lhh lpR fff" container class="bg-white" style="width:40%; max-width:40%;height:40%;">
        <q-header class="bg-primary">
          <q-toolbar>
            <q-toolbar-title>修改施工类型</q-toolbar-title>
            <q-btn flat v-close-popup round dense icon="close" />
          </q-toolbar>
        </q-header>
        <q-page-container>
            ...
            <div class="row items-center" style="margin-bottom:10px">
              ...
              <div class="col col-md-8">
                <div class="text-body1"><q-input
                  v-model="lsit"
                  outlined
                  placeholder="请修改施工类型名称"
                  style="margin-bottom:-20px;"
                  dense
                  :rules="[ val => val && val.length > 0 || '请修改施工类型名称']"
                /></div>
              </div>              
            </div>         
