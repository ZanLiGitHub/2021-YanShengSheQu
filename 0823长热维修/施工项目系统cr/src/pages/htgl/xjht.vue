<template>
 ...
 <div class="col-sm-5 col-xs-12">
   <div class="row items-center" style="margin-bottom:30px">
              ...
              <div class="col col-md-5">
                <q-radio v-model="shape" val="yes" label="是" /><q-radio v-model="shape" val="no" label="否" />
              </div>
            </div>
            <div class="row items-center" style="margin-bottom:30px">
              <div class="col col-md-1 text-right">
            ...
            <div class="row items-center" style="margin-bottom:30px">
              ...
              <div class="col col-md-5">
                <q-input outlined dense bg-color="white" color="grey-9" placeholder="请输入甲方名称">
            ...
            <div class="row items-center" style="margin-bottom:30px">
              ...
              <div class="col col-md-5">
                <q-input outlined dense bg-color="white" color="grey-9" placeholder="请输入乙方名称">
                 <template v-slot:append>
            ...
            <div class="row items-center">
              ...
              placeholder="请输入合同备注"
              dense
              :rules="[ val => val && val.length > 0 || '请输入合同备注']"
            />
              </div>
            </div>
            <div class="row items-center">
