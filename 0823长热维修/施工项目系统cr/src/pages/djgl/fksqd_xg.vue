            ...
            <div class="row items-center" style="margin-bottom:30px">
              ...
              <div class="col col-md-5">
                <q-input
                  ...
                  dense
                  :rules="[ val => val && val.length > 0 || '付款金额']"
                />
              </div>
              <div class="col col-md-1 text-right">
              ...
              <div class="col col-md-5">
                <q-input
                  ...
                  style="margin-bottom:-20px;"
                  dense
                  :rules="[ val => val && val.length > 0 || '应付总金额']"
                />
              </div>
            </div>
            <div class="row items-center" style="margin-bottom:30px">
            ...
            <div class="row items-center" style="margin-bottom:30px">
              ...
              <div class="col col-md-6">
                <div class="text-right">
                  <q-btn outline text-color="blue-8" label="收款单位" class="apply-btn" style="margin-bottom:10px;" @click="gmf = true"/>
                </div>
              </div>
              <div class="col col-md-1 text-right">
              ...
              <div class="col col-md-5">
                <q-input outlined dense bg-color="white" color="grey-9" placeholder="名称">
                 <template v-slot:append>
