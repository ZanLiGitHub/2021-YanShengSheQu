<template>
  <div class="row q-pa-md">
    ...
    <div class="text-right q-gutter-sm q-pt-sm">
      ...
      <q-btn outline text-color="blue-8" label="凭证生成/再次生成" class="apply-btn" @click="pingzheng = true"/>
    </div>
    <q-separator />
    <!--tab 切换 start -->
...
              <td style="text-align: center;">
                <q-btn icon="image_aspect_ratio" flat round dense color="blue" @click="pingzheng = true">
                  <q-tooltip>凭证生成</q-tooltip>
                </q-btn>             
...
            <!-- 操作按钮注释 end-->
    ...
    <q-dialog v-model="layout" >
      <q-layout view="Lhh lpR fff" container class="bg-white" style="width:50%; max-width:50%;height:80%;">
        <q-header class="bg-primary">
          <q-toolbar>
            <q-toolbar-title>查看凭证</q-toolbar-title>
 ...
 <div class="col-sm-5 col-xs-12">
            ...
            <div class="row items-center" style="margin-bottom:10px; padding-bottom:20px;border-bottom:1px #b6b6b6 dashed;">
              ...
              <div class="col col-md-2 text-right">
                <div class="q-mr-sm" style="font-size:14px; color:#757575">金额：</div>
              </div>
              <div class="col col-md-4">
