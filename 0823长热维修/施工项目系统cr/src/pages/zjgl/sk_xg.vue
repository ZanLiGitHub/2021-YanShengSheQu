      ...
      <q-form @submit="onSubmit" @reset="onReset">
         <div class="col-sm-5 col-xs-12">
            <div class="row items-center" style="margin-bottom:30px">
              ...
              <div class="col col-md-1 text-right">
                <div class="q-mr-sm" style="font-size:14px; color:#757575">收款时间</div>
              </div>
              <div class="col col-md-5">
            ...
            <div class="row items-center" style="margin-bottom:30px">
              <div class="col col-md-1 text-right">
                <div class="q-mr-sm" style="font-size:14px; color:#757575">收款金额(元)</div>
              </div>
              <div class="col col-md-5">
                <q-input
                  v-model="lsit"
                  ...
                  dense
                  :rules="[ val => val && val.length > 0 || '收款金额']"
                />
              </div>
              <div class="col col-md-1 text-right">
                <div class="q-mr-sm" style="font-size:14px; color:#757575">应收总金额(元)</div>
              </div>
              <div class="col col-md-5">
                <q-input
                  v-model="lsit"
                  ...
                  style="margin-bottom:-20px;"
                  dense
                  :rules="[ val => val && val.length > 0 || '应收总金额']"
                />
              </div>
            </div>
            <div class="row items-center" style="margin-bottom:30px">
            ...
            <div class="row items-center" style="margin-bottom:30px">
              <div class="col col-md-6">
                <div class="text-h6 q-pb-md">
                  <strong>付款单位信息</strong>
                </div>
              </div>
              <div class="col col-md-6">
                <div class="text-right">
                  <q-btn outline text-color="blue-8" label="选择已有付款单位" class="apply-btn" style="margin-bottom:10px;" @click="gmf = true"/>
                </div>
              </div>
              <div class="col col-md-1 text-right">
              ...
              <div class="col col-md-5">
                <q-input outlined dense bg-color="white" color="grey-9" placeholder="单位名称">
                 <template v-slot:append>
              ...
              <div class="col col-md-5">
                <q-input
                  ...
                  style="margin-bottom:-20px;"
                  dense
                  :rules="[ val => val && val.length > 0 || '纳税人识别号']"
                />
              </div>
            </div>
            <div class="row items-center" style="margin-bottom:30px">
            ...
            <div class="row items-center" style="margin-bottom:30px">
              ...
              <div class="col col-md-5">
                <q-input
                  ...
                  style="margin-bottom:-20px;"
                  dense
                  :rules="[ val => val && val.length > 0 || '开户行']"
                />
              </div>
              <div class="col col-md-1 text-right">
