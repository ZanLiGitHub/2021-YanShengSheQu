...
<!--弹出查看start-->
 ...
 <div class="col-sm-5 col-xs-12">
            ...
            <div class="row items-center" style="margin-bottom:10px">
              ...
              <div class="col col-md-2 text-right">
                <div class="q-mr-sm" style="font-size:14px; color:#757575">项目金额：</div>
              </div>
              <div class="col col-md-4">
                <div class="text-body1">128万元</div>
              </div>
            </div>
            <div class="row items-center" style="margin-bottom:10px">
              <div class="col col-md-2 text-right">
 ...
 <div  class="col-sm-5 col-xs-12" style="text-align:center;">
          <q-btn label="关闭" type="submit" color="primary" />
        </div>
      </q-form>
    </div>
  </div>
...
          }
 ...
 columns1: [
      ...
      sel: null,
      val: true,
      options1: ["项目类型1", "项目类型2"],
      options2: ["施工类型1", "施工类型2"],
      num: null,
      group: ["gro1", "gro2"],
      option: [
        {
