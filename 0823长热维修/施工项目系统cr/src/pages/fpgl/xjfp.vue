      ...
      <q-form @submit="onSubmit" @reset="onReset">
        <div class="col-sm-5 col-xs-12">
           <div class="row items-center" style="margin-bottom:30px">
              ...
              <div class="col col-md-1 text-right">
                <div class="q-mr-sm" style="font-size:14px; color:#757575">开票时间</div>
              </div>
              <div class="col col-md-5">
           ...
           <div class="row items-center" style="margin-bottom:30px">
              <div class="col col-md-6">
                <div class="text-h6 q-pb-md">
                  <strong>购买方详细信息</strong>
                </div>
              </div>
              <div class="col col-md-6">
                <div class="text-right">
                  <q-btn outline text-color="blue-8" label="选择已有购买方" class="apply-btn" style="margin-bottom:10px;" @click="gmf = true"/>
                </div>
              </div>
              <div class="col col-md-1 text-right">
              ...
              <div class="col col-md-5">
                <q-input outlined dense bg-color="white" color="grey-9" placeholder="请输入购买方名称">
                 <template v-slot:append>
              ...
              <div class="col col-md-5">
                <q-input
                  ...
                  dense
                  :rules="[ val => val && val.length > 0 || '请输入购买方纳税人识别号']"
                />
              </div>
            </div>
            <div class="row items-center" style="margin-bottom:30px">
              ...
              <div class="col col-md-5">
                <q-input
                  ...
                  style="margin-bottom:-20px;"
                  dense
                  :rules="[ val => val && val.length > 0 || '请输入购买方地址']"
                />
              </div>
              <div class="col col-md-1 text-right">
              ...
              <div class="col col-md-5">
                <q-input
                  ...
                  style="margin-bottom:-20px;"
                  dense
                  :rules="[ val => val && val.length > 0 || '请输入购买方电话']"
                />
              </div>
            </div>
            <div class="row items-center" style="margin-bottom:30px">
              ...
              <div class="col col-md-5">
                <q-input
                  ...
                  style="margin-bottom:-20px;"
                  dense
                  :rules="[ val => val && val.length > 0 || '请输入购买方开户行']"
                />
              </div>
              <div class="col col-md-1 text-right">
              ...
              <div class="col col-md-5">
                <q-input
                  ...
                  style="margin-bottom:-20px;"
                  dense
                  :rules="[ val => val && val.length > 0 || '请输入购买方账号']"
                />
              </div>
            </div>
              <div class="text-h6 q-pb-md">
            ...
            <div class="row items-center" style="margin-bottom:30px">
              <div class="col col-md-1 text-right">
                <div class="q-mr-sm" style="font-size:14px; color:#757575">发票代码</div>
              </div>
              <div class="col col-md-5">
                <q-input
                  v-model="lsit"
                  ...
                  style="margin-bottom:-20px;"
                  dense
                  :rules="[ val => val && val.length > 0 || '请输入发票代码']"
                />
              </div>
              <div class="col col-md-1 text-right">
                <div class="q-mr-sm" style="font-size:14px; color:#757575">发票号码</div>
              </div>
              <div class="col col-md-5">
                <q-input
                  v-model="lsit"
                  ...
                  style="margin-bottom:-20px;"
                  dense
                  :rules="[ val => val && val.length > 0 || '请输入发票号码']"
                />
              </div>
            </div>
            <div class="row items-center" style="margin-bottom:30px">
              <div class="col col-md-1 text-right">
                <div class="q-mr-sm" style="font-size:14px; color:#757575">数量</div>
              </div>
              <div class="col col-md-5">
                <q-input
                  v-model="lsit"
                  ...
                  style="margin-bottom:-20px;"
                  dense
                  :rules="[ val => val && val.length > 0 || '请输入数量']"
                />
              </div>
              <div class="col col-md-1 text-right">
                <div class="q-mr-sm" style="font-size:14px; color:#757575">单价</div>
              </div>
              <div class="col col-md-5">
                <q-input
                  v-model="lsit"
                  ...
                  style="margin-bottom:-20px;"
                  dense
                  :rules="[ val => val && val.length > 0 || '请输入单价']"
                />
              </div>
            </div>
            <div class="row items-center" style="margin-bottom:30px">
              ...
              <div class="col col-md-5">
                <q-input
                  ...
                  style="margin-bottom:-20px;"
                  dense
                  :rules="[ val => val && val.length > 0 || '请输入税率']"
                />
              </div>
              <div class="col col-md-1 text-right">
                <div class="q-mr-sm" style="font-size:14px; color:#757575">不含税价</div>
              </div>
              <div class="col col-md-5">
                <q-input
                  v-model="lsit"
                  ...
                  style="margin-bottom:-20px;"
                  dense
                  :rules="[ val => val && val.length > 0 || '请输入不含税价']"
                />
              </div>
            </div>
            <div class="row items-center" style="margin-bottom:30px">
              <div class="col col-md-1 text-right">
                <div class="q-mr-sm" style="font-size:14px; color:#757575">税价合计</div>
              </div>
              <div class="col col-md-5">
                <q-input
                  v-model="lsit"
                  ...
                  style="margin-bottom:-20px;"
                  dense
                  :rules="[ val => val && val.length > 0 || '请输入税价合计']"
                />
              </div>
              <div class="col col-md-1 text-right">
            ...
            <div class="row items-center" style="margin-bottom:30px">
              <div class="col col-md-6">
                <div class="text-h6 q-pb-md">
                  <strong>销售方详细信息</strong>
                </div>
              </div>
              <div class="col col-md-6">
                <div class="text-right">
                  <q-btn outline text-color="blue-8" label="选择已有销售方" class="apply-btn" style="margin-bottom:10px;" @click="xsf = true"/>
                </div>
              </div>
              <div class="col col-md-1 text-right">
                <div class="q-mr-sm" style="font-size:14px; color:#757575">名称</div>
              ...
              <div class="col col-md-5">
                <q-input outlined dense bg-color="white" color="grey-9" placeholder="请输入销售方名称">
                 <template v-slot:append>
              ...
              <div class="col col-md-5">
                <q-input
                  ...
                  style="margin-bottom:-20px;"
                  dense
                  :rules="[ val => val && val.length > 0 || '请输入销售方纳税人识别号']"
                />
              </div>
            </div>
            <div class="row items-center" style="margin-bottom:30px">
              ...
              <div class="col col-md-5">
                <q-input
                  ...
                  style="margin-bottom:-20px;"
                  dense
                  :rules="[ val => val && val.length > 0 || '请输入销售方地址']"
                />
              </div>
              <div class="col col-md-1 text-right">
                <div class="q-mr-sm" style="font-size:14px; color:#757575">电话</div>
              ...
              <div class="col col-md-5">
                <q-input
                  ...
                  style="margin-bottom:-20px;"
                  dense
                  :rules="[ val => val && val.length > 0 || '请输入销售方电话']"
                />
              </div>
            </div>
            <div class="row items-center" style="margin-bottom:30px">
              ...
              <div class="col col-md-5">
                <q-input
                  ...
                  style="margin-bottom:-20px;"
                  dense
                  :rules="[ val => val && val.length > 0 || '请输入销售方开户行']"
                />
              </div>
              <div class="col col-md-1 text-right">
                <div class="q-mr-sm" style="font-size:14px; color:#757575">账号</div>
              ...
              <div class="col col-md-5">
                <q-input
                  ...
                  style="margin-bottom:-20px;"
                  dense
                  :rules="[ val => val && val.length > 0 || '请输入销售方账号']"
                />
              </div>
            </div>
  ...
  <div class="q-pa-md q-gutter-sm" style="width:100%">
    <q-dialog v-model="gmf" >
      <q-layout view="Lhh lpR fff" container class="bg-white" style="width:80%; max-width:80%;height:80%;">
        <q-header class="bg-primary">
          <q-toolbar>
            <q-toolbar-title>购买方列表</q-toolbar-title>
            <q-btn flat v-close-popup round dense icon="close" />
          </q-toolbar>
        </q-header>
        <q-page-container>
  ...
  <div class="q-pa-md q-gutter-sm" style="width:100%">
    <q-dialog v-model="xsf" >
      <q-layout view="Lhh lpR fff" container class="bg-white" style="width:80%; max-width:80%;height:80%;">
        <q-header class="bg-primary">
          <q-toolbar>
            <q-toolbar-title>销售方列表</q-toolbar-title>
            <q-btn flat v-close-popup round dense icon="close" />
          </q-toolbar>
        </q-header>
        <q-page-container>
