<template>
  <div class="row q-pa-md">
    <q-breadcrumbs style="width:100%; margin:10px 0;">
      ...
      <q-breadcrumbs-el label="发票管理" icon="receipt_long" to="/xgfp"/>
      <q-breadcrumbs-el label="发票统计" />
    </q-breadcrumbs>
    <!--筛选条件start-->
    <div class="q-pr-sm q-py-sm flex warp q-gutter-xs">
    ...
    <div class="q-py-sm" style="width:400px">
     ...
     <!--筛选条件start-->
    <div class="q-px-sm q-py-sm flex warp q-gutter-xs">
    ...
    <div class="text-right q-gutter-sm q-pt-sm">
      <q-btn outline text-color="blue-8" label="新建发票" class="apply-btn" to="/xjfp"/>
    </div>
    <q-separator />
    <!--tab 切换 start -->
    ...
    <q-dialog v-model="layout" >
      <q-layout view="Lhh lpR fff" container class="bg-white" style="width:80%; max-width:80%;height:80%;">
        <q-header class="bg-primary">
          <q-toolbar>
            <q-toolbar-title>查看发票</q-toolbar-title>
        ...
        <div class="row items-center" style="margin-bottom:10px; padding-bottom:20px;border-bottom:1px #b6b6b6 dashed;">
         <div class="col col-md-2 text-right">
              ...
              <div class="col col-md-4">
                <div class="text-body1">XXXXX合同</div>
              </div>
              <div class="col col-md-2 text-right">
                <div class="q-mr-sm" style="font-size:14px; color:#757575">开票时间：</div>
              </div>
              <div class="col col-md-4">
                <div class="text-body1">2021-01-08</div>
              </div>
            </div>
            
   <div class="row items-center" style="margin-bottom:10px">
              <div class="col col-md-12 text-h6" style="margin-bottom:10px;">
              ...
              <div class="col col-md-4">
                <div class="text-body1">吉林省销售方XXX有限公司</div>
              </div>
              <div class="col col-md-2 text-right">
                <div class="q-mr-sm" style="font-size:14px; color:#757575">纳税人识别号：</div>
              </div>
              <div class="col col-md-4">
                <div class="text-body1">123456789710</div>
              </div>
            </div>
            <div class="row items-center" style="margin-bottom:10px">
              <div class="col col-md-2 text-right">
              ...
              <div class="col col-md-4">
                <div class="text-body1">中国人民银行</div>
              </div>
              <div class="col col-md-2 text-right">
                <div class="q-mr-sm" style="font-size:14px; color:#757575">账号：</div>
              </div>
              <div class="col col-md-4">
                <div class="text-body1">123456789710000</div>
              </div>
            </div>
            <div class="row items-center" style="margin-bottom:10px">
              <div class="col col-md-2 text-right">
              ...
              <div class="col col-md-10">
                <div class="text-body1">吉林省长春市人民大街卫星路XX写字间九层888号</div>
              </div>
            </div>
            <div class="row items-center" style="margin-bottom:10px; padding-bottom:20px;border-bottom:1px #b6b6b6 dashed;">
              <div class="col col-md-2 text-right">
              ...
              <div class="col col-md-10">
                <div class="text-body1">0431-12345678</div>
              </div>
            </div>  
            <div class="row items-center" style="margin-bottom:10px">
              ...
              <div class="col col-md-4">
                <div class="text-body1">12345678</div>
              </div>
              <div class="col col-md-2 text-right">
                <div class="q-mr-sm" style="font-size:14px; color:#757575">发票号码：</div>
              </div>
              <div class="col col-md-4">
                <div class="text-body1">0008888</div>
              </div>
            </div>
            <div class="row items-center" style="margin-bottom:10px">
              <div class="col col-md-2 text-right">
              ...
              <div class="col col-md-4">
                <div class="text-body1">160,000.00元</div>
              </div>
            </div>
            <div class="row items-center" style="margin-bottom:10px">              
              <div class="col col-md-2 text-right">
              ...
              <div class="col col-md-4">
                <div class="text-body1">6%</div>
              </div>
              <div class="col col-md-2 text-right">
                <div class="q-mr-sm" style="font-size:14px; color:#757575">不含税价：</div>
              </div>
              <div class="col col-md-4">
                <div class="text-body1">150,000.00元</div>
              </div>
            </div>
            <div class="row items-center" style="margin-bottom:10px; padding-bottom:20px;border-bottom:1px #b6b6b6 dashed;">
              <div class="col col-md-2 text-right">
                <div class="q-mr-sm" style="font-size:14px; color:#757575">税价合计(元)：</div>
              </div>
              <div class="col col-md-4">
                <div class="text-body1">160,000.00元</div>
              </div>              
